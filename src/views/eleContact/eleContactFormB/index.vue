  ...
  methods: {
    ...
    handleQuery() {
      ...
      if(this.queryParamsSearch.prodOrderNo!=""&&this.queryParamsSearch.prodOrderNo!=null){
        if (this.queryParamsSearch.prodOrderNo.substring(0,2).toUpperCase() == 'WD'|| this.queryParamsSearch.prodOrderNo.substring(0,2).toUpperCase() == '0D'){
          this.queryParams.pageNo = 1;
          // console.log(this.queryParamsSearch)
          this.getListSearch();
        }else if(this.queryParamsSearch.prodOrderNo.substring(0,2).toUpperCase() == 'DJ'){

...
<script>
import { dailyOutputIndex, dailyOutputTop30 } from '@/api/screen/screen'
      ...
      destroyed() {
        ...
        methods: {
          ...
          refreshData() {
              ...
              this.totalPage = this.dataList.length % 8 === 0 ? this.dataList.length / 8 : this.dataList?.length / 8 + 1

...
<script>
    import rid from '@/views/visualization/OEE/M/rid'
    import ridMonth from '@/views/visualization/OEE/M/ridMonth'
    import ridWeek from '@/views/visualization/OEE/M/ridWeek'

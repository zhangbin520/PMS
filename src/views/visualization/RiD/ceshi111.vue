...
import { dailyOutputIndex} from '@/api/screen/screen'
  ...
  props:['refreshDataList'],
      ...
      // created() {
      //   this.dataList = this.refreshDataList
      //   console.log(this.refreshDataList)
      // },
      // watch: {
      //   refreshDataList: {
      //     handler(newVal) {
      //       this.dataList = newVal.fourteenDays
      ...
      mounted(){
        ...
        methods: {
            refreshData() {
              ...
              //   // console.log(resp.data.fourteenDays)
              //       this.initChart(resp.data.fourteenDays)
              //   })
              //  setInterval(() => {
              //    this.refreshData()
              //    console.log(this.refreshDataList.fourteenDays)
              //  }, 500)
              // console.log(this.dataList)

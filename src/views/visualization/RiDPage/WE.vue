...
<script>
    import daily from '@/views/visualization/WE/daily'
    import equip from '@/views/visualization/WE/equip'
    import month from '@/views/visualization/WE/month'
    import outPut from '@/views/visualization/WE/outPut'
    import person from '@/views/visualization/WE/person'
    import week from '@/views/visualization/WE/week'

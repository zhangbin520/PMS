<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="electrodeMaterialInventoryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="重量差值" align="center" prop="subWeight" />
      <el-table-column label="原始数量" align="center" prop="materialNumber" />
      <el-table-column label="盘库数量" align="center" prop="inventoryNumber" />
      <el-table-column label="数量差值" align="center" prop="subNumber" />
...
<script>
import { listElectrodeMaterialInventory, getElectrodeMaterialInventory, delElectrodeMaterialInventory, addElectrodeMaterialInventory, updateElectrodeMaterialInventory, exportElectrodeMaterialInventory } from "@/api/jy/electrodeMaterialInventory";

export default {
  name: "ElectrodeMaterialInventory",
  data() {
    return {
      // 遮罩层
      loading: true,

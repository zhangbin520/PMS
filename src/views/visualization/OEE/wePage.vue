...
<script>
    import rid from '@/views/visualization/OEE/WE/rid'
    import ridMonth from '@/views/visualization/OEE/WE/ridMonth'
    import ridWeek from '@/views/visualization/OEE/WE/ridWeek'
    import moment from 'moment'
    import { cropMovementDept, cropMovementIndex, dailyOutputDept } from '@/api/screen/screen'

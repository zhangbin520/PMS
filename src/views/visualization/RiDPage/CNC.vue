...
<script>
    import daily from '@/views/visualization/CNC/daily'
    import equip from '@/views/visualization/CNC/equip'
    import month from '@/views/visualization/CNC/month'
    import outPut from '@/views/visualization/CNC/outPut'
    import person from '@/views/visualization/CNC/person'
    import week from '@/views/visualization/CNC/week'

...
<!--   <iframe @load="loaded" ref="vueIframe" src="/static/3DView/demo.html" frameborder="0" style="width: 100%;height:89vh"></iframe>-->
<!--   <iframe @load="loaded" ref="vueIframe" src="/static/3dsview/demo.html" frameborder="0" style="width: 100%;height:89vh"></iframe>-->
   <iframe @load="loaded" ref="vueIframe" src="/static/3Dsview1/demo.html" frameborder="0" style="width: 100%;height:89vh"></iframe>
<!--    <iframe @load="loaded" ref="vueIframe" src="/static/SView10.0/demo.html" frameborder="0" style="width: 100%;height:89vh"></iframe>-->
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.routeQuery.a = this.url
      this.routeQuery.b = this.rfid
      this.routeQuery.c = this.token
    ...
    methods: {
      ...
      /** 获取图档路径 */
      loaded() {
        this.iframeWin.postMessage(this.routeQuery,'*');
      },
      /** 控制元素得显示和隐藏 */
      handleControl() {

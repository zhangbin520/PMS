...
<script>
import { listElectrodeMaterialHistory, getElectrodeMaterialHistory, delElectrodeMaterialHistory, addElectrodeMaterialHistory, updateElectrodeMaterialHistory, exportElectrodeMaterialHistory } from "@/api/jy/steelMaterialHistory";

export default {
  name: "SteelMaterialHistory",
  data() {
    return {
      // 遮罩层
      loading: true,

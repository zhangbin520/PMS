...
<script>
    import daily from '@/views/visualization/M/daily'
    import equip from '@/views/visualization/M/equip'
    import month from '@/views/visualization/M/month'
    import outPut from '@/views/visualization/M/outPut'
    import person from '@/views/visualization/M/person'
    import week from '@/views/visualization/M/week'

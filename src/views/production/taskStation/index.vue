               ...
               <div style="float: left">
                <el-form-item label="报工权限：" >  <!-- allPermissionList -->
                  <el-checkbox-group v-model="allPermissionList">
                    <el-checkbox disabled v-for="item in permissionOptionsList" :key="item.id" :label="item.status">{{ item.name }}</el-checkbox>
                  </el-checkbox-group>
                </el-form-item>
       ...
       <el-row>
         <el-form-item label="加工任务状态：" prop="taskStatusList">
           <el-checkbox-group v-model="queryParams.taskStatusList">
             <el-checkbox v-for="item in taskStatusOptions"  :label="item.status">{{ item.name }}</el-checkbox>
           </el-checkbox-group>
         </el-form-item>

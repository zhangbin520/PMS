...
<script>
    import rid from '@/views/visualization/OEE/EDM/rid'
    import ridMonth from '@/views/visualization/OEE/EDM/ridMonth'
    import ridWeek from '@/views/visualization/OEE/EDM/ridWeek'

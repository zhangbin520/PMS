  ...
  <div>
    ...
    <el-card>
      <div align="center">
        ...
        <h2 style="font-weight: bolder;font-size: 20px">模具生产联络单</h2>
      </div>
        ...
        <el-row :gutter="24">
          ...
          <el-col :span="6">
            <div style="margin-top: 5px;" align="center">
              <barcode v-bind:value= "prodOrderNo" style="margin-left: 10px" font-size="20px" height="26mm" width="2mm" text-align="center">
              </barcode>
            </div>
          </el-col>
        </el-row>
      ...
      <div style="margin-top: 10px" align="center">
        <el-table v-loading="loading" :data="filesList" style="width: 80%" max-height="420px">
          ...
          <el-table-column label="估工" align="center" key="workHour" prop="workHour" v-if="false"/>
...
<!--            </el-table-column>-->
      ...
      <el-row :gutter="24">
        <el-col :span="12">
          ...
          <el-table :data="downloadDataTotal" border max-height="600px">
            <el-table-column property="fileName" label="名称" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column label="操作">
              <template slot-scope="scope">
                <el-tooltip class="item" effect="dark" content="查看客户图档" placement="top-start">
                  <el-button
    ...
    <!-- 加工程式下载对话框 WE-->
    <el-dialog :title="programDownloadWE.title" :visible.sync="programDownloadWE.open" width="1200px">
      <el-row :gutter="24">
        <el-col :span="12">
          <span>NC总文件</span>
          <el-table :data="downloadDataTotal" border max-height="600px">
            <el-table-column property="fileName" label="名称" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column property="workingLength" label="加工长度" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column label="操作">
              <template slot-scope="scope">
                <el-tooltip class="item" effect="dark" content="查看客户图档" placement="top-start">
                  <el-button
    ...
    <!--放电参数对话框-->
    <el-dialog :title="Discharge.title" :visible.sync="Discharge.open" width="1800px" append-to-body>
      <el-row :gutter="20">
      ...
      <el-row :gutter="20">
        <h2>EDM明细列表</h2>
        <el-form ref="formDischarge" :model="formDischarge" label-width="150px">
          <el-row>
            <el-col :span="11">
              <el-form-item label="有效高度" prop="vdiFloor">
                <el-input v-model="formDischarge.effectiveHeight"></el-input>
              </el-form-item>
            </el-col>
              <el-col :span="11">
              <el-form-item label="加工面积，投影面积" prop="edmFace">
    ...
    <!-- 钢件上传辅助量测报告-->
    <el-dialog :title="steelMeasurementFile.title" :visible.sync="steelMeasurementFile.open" width="500px" append-to-body>
      <el-upload
        class="pop-upload"
        ref="upload"
        action=""
...
import { getCamElectrodeBom } from '@/api/jy/electrodeMange'
    ...
    // inject:["reload"],
      ...
      methods: {
        ...
        handleQuery() {
          ...
          const prodOrderNo = this.queryParamsSearch.prodOrderNo;
          const progre = prodOrderNo.substring(0,2).toUpperCase();
          // console.log(this.queryParamsSearch.prodOrderNo.substring(0,2).toUpperCase())
          if(this.queryParamsSearch.prodOrderNo!=""&&this.queryParamsSearch.prodOrderNo!=null){
            if (progre == 'GD'|| progre == 'BD'){
              this.queryParams.pageNo = 1;
              // console.log(this.queryParamsSearch)
              this.getListSearch();
            }else if(progre == 'EL'){
              this.$modal.msgError("请输入钢件生产单号")
            }
      ...
      handleDownloadDrawing(row) {
        let downName = row.fileName || row.name;
      ...
      saveAs(blob, filename) {
        ...
        handleOpenProgram(row) {
          ...
          if(row.code === 'CNC'){
            ...
            getCamElectrodeBom({"electrodeProdOrderNo":row.prodOrderNo}).then(resp=>{
        ...
        handleDownloadProgram(row) {
          ...
          if(row.code == 'WE'){
            this.programDownloadWE.open = true
          } else {
        ...
        handleViewFiles(row) {
          ...
          if(this.datasource == '1') {
            ...
            this.steelMeasure.title = "辅助量测报告"
            this.getListMeasure()
          }
        },
      }
